#include <Arduino.h>
#line 1 "C:\\Users\\Bluesky\\Desktop\\MEMORY_BREAD\\esp32s3\\esp32s3.ino"
#include <ESP_I2S.h>
#include <WiFi.h>
...
#line 48 "C:\\Users\\Bluesky\\Desktop\\MEMORY_BREAD\\esp32s3\\esp32s3.ino"
void wifiConnect(void *pvParameters);
#line 67 "C:\\Users\\Bluesky\\Desktop\\MEMORY_BREAD\\esp32s3\\esp32s3.ino"
void startRecording();
#line 94 "C:\\Users\\Bluesky\\Desktop\\MEMORY_BREAD\\esp32s3\\esp32s3.ino"
void stopRecording();
#line 136 "C:\\Users\\Bluesky\\Desktop\\MEMORY_BREAD\\esp32s3\\esp32s3.ino"
void writeWavHeader(File file, uint32_t sampleRate, uint16_t numChannels, uint16_t bitsPerSample);
#line 171 "C:\\Users\\Bluesky\\Desktop\\MEMORY_BREAD\\esp32s3\\esp32s3.ino"
void updateWavHeader(File file);
#line 184 "C:\\Users\\Bluesky\\Desktop\\MEMORY_BREAD\\esp32s3\\esp32s3.ino"
void listDir(fs::FS &fs, const char * dirname, uint8_t levels);
#line 215 "C:\\Users\\Bluesky\\Desktop\\MEMORY_BREAD\\esp32s3\\esp32s3.ino"
bool uploadFile(String filename);
#line 257 "C:\\Users\\Bluesky\\Desktop\\MEMORY_BREAD\\esp32s3\\esp32s3.ino"
void processRecording();
#line 269 "C:\\Users\\Bluesky\\Desktop\\MEMORY_BREAD\\esp32s3\\esp32s3.ino"
void setup();
#line 318 "C:\\Users\\Bluesky\\Desktop\\MEMORY_BREAD\\esp32s3\\esp32s3.ino"
void loop();
#line 48 "C:\\Users\\Bluesky\\Desktop\\MEMORY_BREAD\\esp32s3\\esp32s3.ino"
void wifiConnect(void *pvParameters){
...
void startRecording() {
  ...
  digitalWrite(greenledPin, HIGH);  // 绿色LED亮表示正在录音
...
void stopRecording() {
  ...
  digitalWrite(greenledPin, LOW);  // 绿色LED亮表示正在录音
  // 更新WAV文件头中的数据大小
  updateWavHeader(recordFile);
  
  // 关闭文件
  recordFile.close();  digitalWrite(greenledPin, HIGH);  // 绿色LED亮表示正在录音
  ...
  digitalWrite(redledPin, HIGH);  // 红色LED亮表示正在上传
  int maxRetries = 3;
  for (int i = 0; i < maxRetries; i++) {
    if (uploadFile(filename)) {
      Serial.println("文件上传成功！");
      digitalWrite(redledPin, LOW);  // 红色LED灭表示上传结束
      break;
    } else if (i == maxRetries - 1) {
      Serial.println("文件上传失败，已达最大重试次数！");
    } else {
      Serial.println("上传失败，正在重试...");
      digitalWrite(redledPin, LOW);  // 红色LED闪表示上传失败
      delay(1000);
...
bool uploadFile(String filename) {
  HTTPClient http;
  http.begin("http://10.10.42.46:5002/voice");
